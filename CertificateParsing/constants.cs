...
//{
//    public class AltConstants
//    {
//        public const string MS_ENH_RSA_AES_PROV = "Microsoft Enhanced RSA and AES Cryptographic Provider"; //Name of provider. Same as "Microsoft AES Cryptographic Provider".
//        public const byte PROV_RSA_AES = 24;         //Type of provider
//        public const string KeyContainer = null;     //Name of the key container to be used, if NULL then a default key container name is used. Must be a null-terminated string.
//        public const uint ALG_CLASS_HASH = (4 << 13); //32768 = 4*2^13; //Samma tror jag för alla hashalgoritmer
//        public const uint ALG_TYPE_ANY = (0);       //Samma tror jag för alla hashalgoritmer
//        public const uint ALG_SID_SHA_256 = 12;    //ALG_SID_MD5 = 3, ALG_SID_SHA = 4, ALG_SID_SHA_256 = 12, ALG_SID_SHA_384 = 13, ALG_SID_SHA_512 = 14
//        public const uint CALG_SHA_256 = (ALG_CLASS_HASH | ALG_TYPE_ANY | ALG_SID_SHA_256);
//        public const int ALG_CLASS_DATA_ENCRYPT = 24576;
//        public const int ALG_TYPE_BLOCK = 1536;       //used in all types of AES, and in RC2
//        public const int ALG_SID_AES_256 = 16; //ALG_SID_AES_128 = 14, ALG_SID_AES_192 = 15, ALG_SID_AES_256 = 16
//        public const int CALG_AES_256 = (ALG_CLASS_DATA_ENCRYPT | ALG_TYPE_BLOCK | ALG_SID_AES_256);
//        public const int ENCRYPT_ALGORITHM = CALG_AES_256;
